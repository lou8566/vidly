...
describe("/api/returns", () => {
  ...
  // Return 401 if movieId is not provided
  ...
  // Increase stock for movie
  it("Should Increase stock for movie if request is valid", async () => {
    await exec();
  ...
  // Return the rental
  it("Should Return the rental is valid", async () => {
    const res = await exec();
